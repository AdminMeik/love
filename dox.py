...
class DoxMod(loader.Module):
    ...
    strings = {
        "name": "@YMEPOTBAC dox",
        "usage": "Загрузите модуль, чтобы использовать .ymepotbaclist.",
    }
    ...
    async def ymepotbaccmd(self, message):
        ...
        await utils.answer(message, "👁️ <b>Докс от @YMEPOTBAC запущен...</b>")
        await sleep(0.5)
        ...
        result_message = (
            ...
            f"\n<b>Докс сгенерирован системой @YMEPOTBAC</b>"
        )
